...
cap <- read.table("https://people.sc.fsu.edu/~jburkardt/datasets/states/state_capitals_ll.txt", header = FALSE)
...
#bind together "https://api.g7vrd.co.uk/v1/satellite-passes/25544/", lat, "/", long, ".json"
```
